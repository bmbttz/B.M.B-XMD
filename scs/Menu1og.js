...
const { format, styletext } = require(__dirname + "/../Ibrahim/mesfonctions");
//const {police}=require(__dirname+"/../framework/mesfonctions")
const os = require("os");
const moment = require("moment-timezone");
const s = require(__dirname + "/../set");
zokou({ nomCom: "ted", categorie: "Menu" }, async (dest, zk, commandeOptions) => {
...
╚════--------------- \n\n`;
    ...
    try {
        zk.sendMessage(dest, { image: { url: link }, caption: menuMsg, footer: "© B.M.B💚XMD" }, { quoted: ms });
    }
    catch (e) {
