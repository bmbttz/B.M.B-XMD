...
const repositories = [
    "ibrahimaitech/B.M.B-XMD",
    "ibrahimaitech/B.M.B-NORMAL-BOT",
    "devibrah/NORMAL-BOT",
    "devibraah/B.M.B-XMD", // Main repository to display
];
...
const fetchAndAggregateRepoDetails = async () => {
    try {
        ...
        const mainRepoResponse = await axios.get(`https://api.github.com/repos/devbmb/B.M.B-XMD`);
            ...
            await zk.sendMessage(dest, {
                ...
                contextInfo: {
                    externalAdReply: {
                        ...
                        thumbnailUrl: "https://files.catbox.moe/6p6jkb.jpg", // Replace with your image URL
                        mediaType: 1,
                        renderLargerThumbnail: true, // Ensures a larger thumbnail display
                        showAdAttribution: true, 
                        mediaUrl: "https://whatsapp.com/channel/0029Vb2eknR59PwL1OK4wR24",
                        sourceUrl: "https://whatsapp.com/channel/0029Vb2eknR59PwL1OK4wR24", // Source URL in context
                    },
                },
            });
        } catch (e) {
