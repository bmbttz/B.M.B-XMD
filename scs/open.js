...
/*adams({nomCom:"open",categorie:"General",reaction:"🤭"},async(dest,zk,commandeOptions)=>{
...
adams({ nomCom: "open", aliases: ["send", "keep"], categorie: "new" }, async (dest, zk, commandeOptions) => {
