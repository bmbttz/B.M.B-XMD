...
let restartTimeout;
function start() {
  console.log("𝙱𝙼𝙱 𝚇𝙼𝙳 is running smoothly 🎡");
...
function generateBio(nomAuteurMessage = "User") {
    ...
    return `🙋HEY,  ${nomAuteurMessage} 𝙱𝙼𝙱 𝚇𝙼𝙳 IS ONLINE 🤳,\n💹 ${currentDateTime}\n💬 "${quote}"`;
}
...
let auto_reply_message = "Hello, I am 𝙱𝙼𝙱 𝚇𝙼𝙳. My owner is currently unavailable. Please leave a message, and he will get back to you as soon as possible.";
...
zk.ev.on('group-participants.update', async (group) => {
    ...
    try {
        ...
        if (group.action == 'add' && (await recupevents(group.id, "welcome") == 'on')) {
            let msg = `*𝙱𝙼𝙱 𝚇𝙼𝙳 WELCOME MESSAGE*`;
    ...
    async  function activateCrons() {
        ...
        zk.ev.on("connection.update", async (con) => {
            ...
            if (connection === "connecting") {
                ...
                console.log("𝙱𝙼𝙱 𝚇𝙼𝙳 connected successfully✔");
                console.log("--");
                await (0, baileys_1.delay)(200);
                console.log("------");
                await (0, baileys_1.delay)(300);
                console.log("------------------/-----");
                console.log("𝙱𝙼𝙱 𝚇𝙼𝙳 is Online 🕸\n\n");
