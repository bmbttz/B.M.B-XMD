...
let auto_reply_message = "Hello, I am 𝙱.𝙼.𝙱 𝚇𝙼𝙳. My owner is currently unavailable. Please leave a message, and he will get back to you as soon as possible.";
...
zk.ev.on('group-participants.update', async (group) => {
    ...
    try {
        ...
        if (group.action == 'add' && (await recupevents(group.id, "welcome") == 'on')) {
            let msg = `*B.M.B-XMD WELCOME MESSAGE*`;
    ...
    async  function activateCrons() {
        ...
        zk.ev.on("connection.update", async (con) => {
            ...
            if (connection === "connecting") {
                ...
                console.log("Loading 𝙱.𝙼.𝙱 Commands ...\n");
